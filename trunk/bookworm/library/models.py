...
class BookAuthor(BookwormModel):
    '''Authors are not normalized as there is no way to guarantee u    def _get_metadata(self, metadata_tag, opf, plural=False, as_string=False, as_list=False):
